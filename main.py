...
physicalHealth = st.sidebar.slider("Wie oft füllten Sie sich in den vergangen 30 Tagen physisch nicht gut?", 0, 30, 5)
mentalHealth = st.sidebar.slider("Wie oft füllten Sie sich in den vergangen 30 Tagen mental nicht gut?", 0, 30, 5)
