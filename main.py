...
ax.bar(1, berechneHeartDisease(), color = '#93c47d' if berechneHeartDisease() < 0.3 or '#ffd966' elif 0.3 < berechneHeartDisease() < 0.6 else '#cc4125') #weiß noch nicht, wie ich hier eine farbe in der Mitte hinbekomme
